...
class PlanetsControllerTest < ActionController::TestCase
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post :create, planet: { color: @planet.color, name: @planet.name, num_of: @planet.num_of, satellites: @planet.satellites }
    end
  ...
  test "should update planet" do
    patch :update, id: @planet, planet: { color: @planet.color, name: @planet.name, num_of: @planet.num_of, satellites: @planet.satellites }
    assert_redirected_to planet_path(assigns(:planet))
  end
